...
def try_methods():
    rori = rg.SimpleTurtle()
    rori.pen = rg.Pen('brown',5)
    rori.forward(150)
    rori.left(90)
    rori.forward(50)
    rori.backward(100)
...
def try_functions():
    kim = rg.SimpleTurtle()
    kim.pen_up()
    kim.go_to(rg.Point(200,100))
    kim.pen_down()
    kim.pen = rg.Pen('brown',5)
    kim.go_to(rg.Point(300,30))
    kourt = rg.SimpleTurtle()
    kourt.pen_up()
    kourt.go_to(rg.Point(100,200))
    kourt.pen = rg.Pen('purple', 2)
    kourt.pen_down()
    kourt.go_to(rg.Point(0,0))
    khloe = rg.SimpleTurtle()
    khloe.pen_up()
    khloe.go_to(rg.Point(-50,50))
    khloe.pen_down()
    khloe.pen = rg.Pen('pink', 4)
    khloe.go_to(rg.Point(100,100))
